...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public List<Semboyan> getisyarat(){
        Semboyan dictionaryModel=null;
        List<Semboyan> dictionaryModelList=new ArrayList<>();
        openDatabase();

        Cursor cursor=mDatabase.rawQuery("Select * From semboyan where kategori = \"ssementaraisyarat\" order by singkatan asc", null);
        cursor.moveToFirst();
        while (!cursor.isAfterLast()){
            dictionaryModel=new Semboyan(cursor.getInt(0),cursor.getString(1),cursor.getString(2), cursor.getString(3)
                    , cursor.getString(4), cursor.getString(5));
    ...
    public List<Semboyan> gettanda(){
        Semboyan dictionaryModel=null;
        List<Semboyan> dictionaryModelList=new ArrayList<>();
        openDatabase();

        Cursor cursor=mDatabase.rawQuery("Select * From semboyan where kategori = \"ssementaratanda\" order by singkatan asc", null);
        cursor.moveToFirst();
        while (!cursor.isAfterLast()){
            dictionaryModel=new Semboyan(cursor.getInt(0),cursor.getString(1),cursor.getString(2), cursor.getString(3)
                    , cursor.getString(4), cursor.getString(5));
    ...
    public List<Semboyan> getsinyal(){
        Semboyan dictionaryModel=null;
        List<Semboyan> dictionaryModelList=new ArrayList<>();
        openDatabase();

        Cursor cursor=mDatabase.rawQuery("Select * From semboyan where kategori = \"stetapsinyal\" order by singkatan asc", null);
        cursor.moveToFirst();
        while (!cursor.isAfterLast()){
            dictionaryModel=new Semboyan(cursor.getInt(0),cursor.getString(1),cursor.getString(2), cursor.getString(3)
                    , cursor.getString(4), cursor.getString(5));
    ...
    public List<Semboyan> gettandatetap(){
        Semboyan dictionaryModel=null;
        List<Semboyan> dictionaryModelList=new ArrayList<>();
        openDatabase();

        Cursor cursor=mDatabase.rawQuery("Select * From semboyan where kategori = \"stetaptanda\" order by singkatan asc", null);
        cursor.moveToFirst();
        while (!cursor.isAfterLast()){
            dictionaryModel=new Semboyan(cursor.getInt(0),cursor.getString(1),cursor.getString(2), cursor.getString(3)
                    , cursor.getString(4), cursor.getString(5));
    ...
    public List<Semboyan> gettetapmarka(){
        Semboyan dictionaryModel=null;
        List<Semboyan> dictionaryModelList=new ArrayList<>();
        openDatabase();

        Cursor cursor=mDatabase.rawQuery("Select * From semboyan where kategori = \"stetapmarka\" order by singkatan asc", null);
        cursor.moveToFirst();
        while (!cursor.isAfterLast()){
            dictionaryModel=new Semboyan(cursor.getInt(0),cursor.getString(1),cursor.getString(2), cursor.getString(3)
                    , cursor.getString(4), cursor.getString(5));
    ...
    public List<Semboyan> getwesel(){
        Semboyan dictionaryModel=null;
        List<Semboyan> dictionaryModelList=new ArrayList<>();
        openDatabase();

        Cursor cursor=mDatabase.rawQuery("Select * From semboyan where kategori = \"swesel\" order by singkatan asc", null);
        cursor.moveToFirst();
        while (!cursor.isAfterLast()){
            dictionaryModel=new Semboyan(cursor.getInt(0),cursor.getString(1),cursor.getString(2), cursor.getString(3)
                    , cursor.getString(4), cursor.getString(5));
    ...
    public List<Semboyan> getterlihat(){
        Semboyan dictionaryModel=null;
        List<Semboyan> dictionaryModelList=new ArrayList<>();
        openDatabase();

        Cursor cursor=mDatabase.rawQuery("Select * From semboyan where kategori = \"sterlihat\" order by singkatan asc", null);
        cursor.moveToFirst();
        while (!cursor.isAfterLast()){
            dictionaryModel=new Semboyan(cursor.getInt(0),cursor.getString(1),cursor.getString(2), cursor.getString(3)
                    , cursor.getString(4), cursor.getString(5));
    ...
    public List<Semboyan> getsuara(){
        Semboyan dictionaryModel=null;
        List<Semboyan> dictionaryModelList=new ArrayList<>();
        openDatabase();

        Cursor cursor=mDatabase.rawQuery("Select * From semboyan where kategori = \"ssuara\" order by singkatan asc", null);
        cursor.moveToFirst();
        while (!cursor.isAfterLast()){
            dictionaryModel=new Semboyan(cursor.getInt(0),cursor.getString(1),cursor.getString(2), cursor.getString(3)
                    , cursor.getString(4), cursor.getString(5));
    ...
    public List<Semboyan> getlangsir(){
        Semboyan dictionaryModel=null;
        List<Semboyan> dictionaryModelList=new ArrayList<>();
        openDatabase();


        Cursor cursor=mDatabase.rawQuery("Select * From semboyan where kategori = \"sslangsir\" order by singkatan asc", null);
        cursor.moveToFirst();
        while (!cursor.isAfterLast()){
            dictionaryModel=new Semboyan(cursor.getInt(0),cursor.getString(1),cursor.getString(2), cursor.getString(3)
                    , cursor.getString(4), cursor.getString(5));
